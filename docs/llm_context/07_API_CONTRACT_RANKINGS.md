...
- 집계 규칙:
  ...
  - 금액 필드:
    - `cpOnline2025`, `cpOffline2025`는 2025 확정/높음 딜 중 시작연도가 2026이 아닌 건만 합산(온라인/비온라인 구분). `cpTotal2025 = online+offline`.
    - `cpOnline2026`, `cpOffline2026`는 2026 확정/높음 딜 + 2025 딜이면서 시작연도 2026인 건을 해당 rail에 가산.
    - 26 온라인 타겟 = `cpOnline2025 × 1.0` (배수 고정 1), 26 비온라인 타겟은 기존 티어 배수 유지(S0=1.5, P0/P1=1.7, P2=1.5).
- 비온라인 합산:
